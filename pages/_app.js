...
export default function App({ Component, pageProps }) {
    return (
        <div>
            ...
            <Script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyAx0A3PJLlnOZlxt1t4L_-wVUOColABUvQ&libraries=places&callback=Function.prototype' strategy='beforeInteractive' onLoad={()=>{console.log("successfuly logged google maps api")}}></Script>
