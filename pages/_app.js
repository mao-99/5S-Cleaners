...
export default function App({ Component, pageProps }) {
    return (
        <div>
            ...
            <Script src={`https://maps.googleapis.com/maps/api/js?libraries=places&key=${process.env.GOOGLE_MAPS_API_KEY}`} strategy='beforeInteractive' onLoad={()=>{console.log("successfuly logged google maps api")}}></Script>
